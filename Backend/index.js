...
var players = {}; // It will keep all the players data who have register using mobile number. you can use actual persistence database I have used this for temporary basis
...
// STEP 4 ::=> When any request comes it will trigger and bind all the sequence events that will triggered as per app logic
io.on('connection', client => {
    ...
    // STEP 7 ::=> It will send all the players who are online and available to play the game
    ...
    // STEP 9 ::=> When Player select any cell then it will check all the necessary logic of Tic Tac Toe Game
